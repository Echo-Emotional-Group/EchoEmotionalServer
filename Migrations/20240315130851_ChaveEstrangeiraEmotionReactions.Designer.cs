...
namespace EchoEmotionalServer.Migrations
{
    ...
    [Migration("20240315130851_ChaveEstrangeiraEmotionReactions")]
    partial class ChaveEstrangeiraEmotionReactions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Emotion_Reaction", b =>
                {
                    ...
                    b.Property<string>("Perfil_UserId_accont_facebook")
                        .IsRequired()
                        .HasColumnType("text");

                    b.HasKey("Emotion_Id", "Reaction_Id", "Id_account_facebook");

                    b.HasIndex("Perfil_UserId_accont_facebook");
            ...
            modelBuilder.Entity("Models.Emotion_Reaction", b =>
                {
                    ...
                    b.HasOne("Models.Perfil_User", "Perfil_User")
                        .WithMany("Emotion_Reactions")
                        .HasForeignKey("Perfil_UserId_accont_facebook")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
